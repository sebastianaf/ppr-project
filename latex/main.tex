...
\begin{itemize}
    \item $Disponibilidad$: Este es un arreglo asociativo que contiene las restricciones de dispibilidad de algunos de los actores especificados en el conjunto de $Actores$. $Disponibilidad_{i} \in \mathbb{N} con i \in ACTORES$ representa la cantidad de horas máxima que el actor puede estár disponible para la grabación de la telenovela, $Disponibilidad_{i} = 0$ significa que el actor $i$ no tiene restricciones de tiempo.
    \item 
\end{itemize}
